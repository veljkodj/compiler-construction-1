...
public class MethodVarDeclarationList extends MethodVarDeclList {

    private MethodVarDeclList MethodVarDeclList;
    private VarDecl VarDecl;

    public MethodVarDeclarationList (MethodVarDeclList MethodVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVarDeclarationList(\n");
